...
app.get("/search", (request, response) => {
    ...
    for(var i = 0; i < places.length; i++){
        results += "<div class='results'><image class='resultImages' src=" + places[i].image + "></image><button class='rentButton'>Rent Me!</button><p>Address: " + places[i].street + ", " + places[i].city + " " + places[i].state + " " 
